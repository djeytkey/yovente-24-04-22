...
class SaleController extends Controller
{
    ...
    public function create()
    {
        ...
        if($role->hasPermissionTo('sales-add')){
            ...
            return view('sale.create',compact('role', 'lims_cities_list', 'lims_customer_list', 'lims_warehouse_list', 'lims_biller_list', 'lims_pos_setting_data', 'lims_tax_list', 'lims_general_setting_data'));
        }
        else
            return redirect()->back()->with('not_permitted', 'Sorry! You are not allowed to access this module');
    }
    ...
    public function getProduct($id)
    {
        ...
        foreach ($lims_product_warehouse_data as $product_warehouse) //-----> 1
        {
        ...
        foreach ($lims_product_with_batch_warehouse_data as $product_warehouse) //-----> 0
        {
            $product_qty[] = $product_warehouse->qty;
            $product_price[] = $product_warehouse->price;
            $lims_product_data = Product::find($product_warehouse->product_id);
        ...
        foreach ($lims_product_with_variant_warehouse_data as $product_warehouse) //-----> 15
        {
            $product_qty[] = $product_warehouse->qty;
            $lims_product_data = Product::find($product_warehouse->product_id);
