                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label><?php echo e(trans('file.Destinataire')); ?> *</label>
                                            <input type="text" name="customer_name" id="customer_name" class="form-control" placeholder="<?php echo e(trans('file.Customer Name')); ?>..." required/>
                                            <?php $deposit = []; ?>                                            
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label><?php echo e(trans('file.Telephone')); ?> * (ex: 0612345678)</label>
                                            ...
                                            <table id="myTable" class="table table-hover order-list">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th><?php echo e(trans('file.Sale Price')); ?></th>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\yovente-24-04-22\resources\views/sale/create.blade.php ENDPATH**/ ?>