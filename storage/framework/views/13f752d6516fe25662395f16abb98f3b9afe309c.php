                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <h3><?php echo e(strtolower(Auth::user()->name) . '-' . date("ymd") . '-'. date("His")); ?></h3>
                                            <input type="hidden" name="reference_no" class="form-control" value="<?php echo e(strtolower(Auth::user()->name) . '-' . date("ymd") . '-'. date("His")); ?>"/>
                                        </div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\yovente\resources\views/sale/create.blade.php ENDPATH**/ ?>